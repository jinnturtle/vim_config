...
" Special Variables
syn keyword	ksSpecialVar	steering throttle ship
hi def link	ksSpecialVar	Special

" Shortcut Variables
syn keyword ksShortcutVar heading
hi def link ksShortcutVar Constant
...
" Repeats and friends "{{{1
syn keyword	ksRepeat	for until in do from step
